...
export default function SignUP() {
  ...
  return (
      ...
      <header className='sm:w-420 flex-center flex-col text-center p-4 m-2'>
        ...
        <h2 className='h2:bold text-2xl font-semibold p-4'>Create a new account</h2>
      ...
      <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input className = 'bg-black' type='text'   placeholder="Socrates" {...field}/>
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input className = 'bg-black' type='password'   placeholder="Socrates1234" {...field}/>
              </FormControl>
              <FormDescription className='text-gray-300'>
              </FormDescription>
              <FormMessage />
        ...
        <p className=' text-sm text-white-2 text-center mt-2'>
          Alredy have an account? <Link to = '/sign-in' className=' text-blue-900 font-semibold'>Login</Link>
        </p>
      </form>
    </Form>
      </div>
